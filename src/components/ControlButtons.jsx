    ...
    <>
      <div className="flex flex-col gap-2 w-full">
        ...
        <button
          onClick={start}
          disabled={isRunning}
          className={`w-full py-4 rounded-xl font-display text-xl tracking-widest transition-all flex items-center justify-center gap-2.5 ${
            isRunning
        ...
        <div className="flex gap-2">
          <button
            onClick={pause}
            disabled={!isRunning}
            className={`flex-1 py-3 rounded-xl font-display text-sm tracking-widest transition-all flex items-center justify-center gap-1.5 ${
              !isRunning
          ...
          <button
            ...
            disabled={isIdle}
            className={`w-11 py-3 rounded-xl transition-all flex items-center justify-center ${
              isIdle
